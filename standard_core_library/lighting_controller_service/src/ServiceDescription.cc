...
const std::string ControllerServiceLampDescription =
    ...
    "      <arg name='lampID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='TransitionLampStateToSavedState'>"
    "      <arg name='lampID' type='s' direction='in'/>"
    "      <arg name='savedStateID' type='s' direction='in'/>"
    "      <arg name='transitionPeriod' type='u' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='lampID' type='s' direction='out'/>"
    "    </method>"
...
const std::string ControllerServiceLampGroupDescription =
    ...
    "      <arg name='lampGroupID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='TransitionLampGroupStateToSavedState'>"
    "      <arg name='lampGroupID' type='s' direction='in'/>"
    "      <arg name='savedStateID' type='s' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='lampGroupID' type='s' direction='out'/>"
...
const std::string ControllerServiceSavedStateDescription =
    "<node>"
    "  <interface name='org.allseen.LSF.ControllerService.SavedState'>"
    ...
    "      <arg name='responseCode' type='u' direction='out'/>"
    "    </method>"
    "    <method name='GetAllSavedStateIDs'>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='savedStateIDs' type='as' direction='out'/>"
    "    </method>"
    "    <method name='GetSavedStateName'>"
    "      <arg name='savedStateID' type='s' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='savedStateID' type='s' direction='out'/>"
    "      <arg name='savedStateName' type='s' direction='out'/>"
    "    </method>"
    "    <method name='SetSavedStateName'>"
    "      <arg name='savedStateID' type='s' direction='in'/>"
    "      <arg name='savedStateName' type='s' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='savedStateID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='CreateSavedState'>"
    "      <arg name='lampState' type='a{sv}' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='savedStateID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='UpdateSavedState'>"
    "      <arg name='savedStateID' type='s' direction='in'/>"
    "      <arg name='lampState' type='a{sv}' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='savedStateID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='DeleteSavedState'>"
    "      <arg name='savedStateID' type='s' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='savedStateID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='GetSavedState'>"
    "      <arg name='savedStateID' type='s' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='savedStateID' type='s' direction='out'/>"
    "      <arg name='lampState' type='a{sv}' direction='out'/>"
    ...
    "    </signal>"
    "    <signal name='SavedStatesNameChanged'>"
    "      <arg name='savedStateIDs' type='as' direction='out'/>"
    "    </signal>"
    "    <signal name='SavedStatesCreated'>"
    "      <arg name='savedStatesIDs' type='as' direction='out'/>"
    "    </signal>"
    "    <signal name='SavedStatesUpdated'>"
    "      <arg name='savedStatesIDs' type='as' direction='out'/>"
    "    </signal>"
    "    <signal name='SavedStatesDeleted'>"
    "      <arg name='savedStatesIDs' type='as' direction='out'/>"
    "    </signal>"
    "  </interface>"
    "</node>";
...
const std::string ControllerServiceSceneDescription =
    ...
    "      <arg name='lampsLampGroupsState' type='a(asasa{sv}u)' direction='in'/>"
    "      <arg name='lampsLampGroupsSavedState' type='a(asassu)' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='sceneID' type='s' direction='out'/>"
    "    </method>"
    ...
    "      <arg name='sceneID' type='s' direction='in'/>"
    "      <arg name='lampsLampGroupsState' type='a(asasa{sv}u)' direction='out'/>"
    "      <arg name='lampsLampGroupsSavedState' type='a(asassu)' direction='out'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "    </method>"
...
const std::string ControllerServiceSceneGroupDescription =
    "<node>"
    "  <interface name='org.allseen.LSF.ControllerService.SceneGroup'>"
    "    <method name='GetAllSceneGroupIDs'>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='sceneGroupIDs' type='as' direction='out'/>"
    "    </method>"
    "    <method name='GetSceneGroupName'>"
    "      <arg name='sceneGroupID' type='s' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='sceneGroupID' type='s' direction='out'/>"
    "      <arg name='sceneGroupName' type='s' direction='out'/>"
    "    </method>"
    "    <method name='SetSceneGroupName'>"
    "      <arg name='sceneGroupID' type='s' direction='in'/>"
    "      <arg name='sceneGroupName' type='s' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='sceneGroupID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='CreateSceneGroup'>"
    "      <arg name='scenes' type='as' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='sceneGroupID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='UpdateSceneGroup'>"
    "      <arg name='sceneGroupID' type='s' direction='in'/>"
    "      <arg name='scenes' type='as' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='sceneGroupID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='DeleteSceneGroup'>"
    "      <arg name='sceneGroupID' type='s' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='sceneGroupID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='GetSceneGroup'>"
    "      <arg name='sceneGroupID' type='s' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='sceneGroupID' type='s' direction='out'/>"
    "      <arg name='scenes' type='as' direction='out'/>"
    "    </method>"
    "    <method name='ApplySceneGroup'>"
    "      <arg name='sceneGroupID' type='s' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='sceneGroupID' type='s' direction='out'/>"
    "    </method>"
    "    <signal name='SceneGroupsNameChanged'>"
    "      <arg name='sceneGroupIDs' type='as' direction='out'/>"
    "    </signal>"
    "    <signal name='SceneGroupsCreated'>"
    "      <arg name='sceneGroupIDs' type='as' direction='out'/>"
    "    </signal>"
    "    <signal name='SceneGroupsUpdated'>"
    "      <arg name='sceneGroupIDs' type='as' direction='out'/>"
    "    </signal>"
    "    <signal name='SceneGroupsDeleted'>"
    "      <arg name='sceneGroupIDs' type='as' direction='out'/>"
    "    </signal>"
    "    <signal name='SceneGroupsApplied'>"
    "      <arg name='sceneGroupIDs' type='as' direction='out'/>"
    "    </signal>"
    "  </interface>"
    "</node>";

...
const std::string ControllerServiceLampDescription =
    ...
    "      <arg name='lampID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='StrobeLampWithState'>"
    "      <arg name='lampID' type='s' direction='in'/>"
    "      <arg name='fromLampState' type='a{sv}' direction='in'/>"
    "      <arg name='toLampState' type='a{sv}' direction='in'/>"
    "      <arg name='period' type='u' direction='in'/>"
    "      <arg name='numStrobes' type='u' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='lampID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='CycleLampWithState'>"
    "      <arg name='lampID' type='s' direction='in'/>"
    "      <arg name='fromLampState' type='a{sv}' direction='in'/>"
    "      <arg name='toLampState' type='a{sv}' direction='in'/>"
    "      <arg name='period' type='u' direction='in'/>"
    "      <arg name='duration' type='u' direction='in'/>"
    "      <arg name='numCycles' type='u' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='lampID' type='s' direction='out'/>"
    "    </method>"
    ...
    "      <arg name='lampID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='StrobeLampWithPreset'>"
    "      <arg name='lampID' type='s' direction='in'/>"
    "      <arg name='fromPresetID' type='s' direction='in'/>"
    "      <arg name='toPresetID' type='s' direction='in'/>"
    "      <arg name='period' type='u' direction='in'/>"
    ...
    "      <arg name='lampID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='CycleLampWithPreset'>"
    "      <arg name='lampID' type='s' direction='in'/>"
    "      <arg name='presetIdA' type='s' direction='in'/>"
    "      <arg name='presetIdB' type='s' direction='in'/>"
    "      <arg name='period' type='u' direction='in'/>"
    "      <arg name='duration' type='u' direction='in'/>"
    "      <arg name='numCycles' type='u' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    ...
    "    </method>"
    "    <method name='GetLampRemainingLife'>"
    "      <arg name='lampID' type='s' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='lampID' type='s' direction='out'/>"
    "      <arg name='remainingLife' type='u' direction='out'/>"
    "    </method>"
...
const std::string ControllerServiceLampGroupDescription =
    ...
    "      <arg name='lampGroupID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='StrobeLampGroupWithState'>"
    "      <arg name='lampGroupID' type='s' direction='in'/>"
    "      <arg name='fromLampGroupState' type='a{sv}' direction='in'/>"
    "      <arg name='toLampGroupState' type='a{sv}' direction='in'/>"
    "      <arg name='period' type='u' direction='in'/>"
    ...
    "      <arg name='lampGroupID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='CycleLampGroupWithState'>"
    "      <arg name='lampGroupID' type='s' direction='in'/>"
    "      <arg name='lampGroupStateA' type='a{sv}' direction='in'/>"
    "      <arg name='lampGroupStateB' type='a{sv}' direction='in'/>"
    "      <arg name='period' type='u' direction='in'/>"
    "      <arg name='duration' type='u' direction='in'/>"
    "      <arg name='numCycles' type='u' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    ...
    "      <arg name='lampGroupID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='StrobeLampGroupWithPreset'>"
    "      <arg name='lampGroupID' type='s' direction='in'/>"
    "      <arg name='fromPresetID' type='s' direction='in'/>"
    "      <arg name='toPresetID' type='s' direction='in'/>"
    "      <arg name='period' type='u' direction='in'/>"
    ...
    "      <arg name='lampGroupID' type='s' direction='out'/>"
    "    </method>"
    "    <method name='CycleLampGroupWithPreset'>"
    "      <arg name='lampGroupID' type='s' direction='in'/>"
    "      <arg name='presetIdA' type='s' direction='in'/>"
    "      <arg name='presetIdB' type='s' direction='in'/>"
    "      <arg name='period' type='u' direction='in'/>"
...
const std::string ControllerServiceSceneDescription =
    ...
    "      <arg name='strobelampsLampGroupsWithState' type='a(asasa{sv}a{sv}uu)' direction='in'/>"
    "      <arg name='strobelampsLampGroupsWithPreset' type='a(asasssuu)' direction='in'/>"
    "      <arg name='cyclelampsLampGroupsWithState' type='a(asasa{sv}a{sv}uuu)' direction='in'/>"
    "      <arg name='cyclelampsLampGroupsWithPreset' type='a(asasssuuu)' direction='in'/>"
    "      <arg name='responseCode' type='u' direction='out'/>"
    "      <arg name='sceneID' type='s' direction='out'/>"
    "    </method>"
    ...
    "      <arg name='strobelampsLampGroupsWithState' type='a(asasa{sv}a{sv}uu)' direction='out'/>"
    "      <arg name='strobelampsLampGroupsWithPreset' type='a(asasssuu)' direction='out'/>"
    "      <arg name='cyclelampsLampGroupsWithState' type='a(asasa{sv}a{sv}uuu)' direction='out'/>"
    "      <arg name='cyclelampsLampGroupsWithPreset' type='a(asasssuuu)' direction='out'/>"
    "    </method>"
